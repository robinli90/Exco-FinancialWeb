...
namespace BatchUpdate
{
    ...
    public class RunTime
    {
        ...
        public void ProcessEmployeeNumber()
        {
            if (0 == empNum)
            {
                empNum = 99999;
        ...
        public List<string> GenerateBatchString()
        {
            ...
            else
            {
                if (100 == seqNum)
                {
                    batchList.AddRange(GenerateMaterialBatch());
                }
                else
                {
        ...
        public List<string> GenerateMaterialBatch()
        {
            List<string> batch = new List<string>();
            // add detail record
            DetailRecord detail = new DetailRecord();
        ...
        // calculate run time
        public void CalcualteRunTime(DateTime date)
        {
...
[0].taskTime;
        ...
        public void CalculateStartStop()
        {
            DeleteLastTaskIfStart();
