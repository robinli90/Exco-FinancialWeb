...
namespace BatchUpdate
{
    public class Die
    {
        ...
        public void GetEvenTime(int seqNum, Dictionary<string, Dictionary<int, SeqTemplate>> seqCJOBHMap, Dictionary<string, SeqTemplate> seqHJOBHMap)
        {
