<%@ Page Title="Customer Die Information" Language="C#" MasterPageFile="../Site.master"
    AutoEventWireup="true" CodeFile="CustPurchases.aspx.cs" Inherits="invoice_register" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">
    <div align="center">
        <font size="18" color="red">Customer Die Purchases</font>
    </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
              <div align="center">
                ...
                <asp:TextBox ID="Year2" runat="server" BorderStyle="None" Font-Bold="True" Font-Size="Large"
                    ForeColor="Blue" Height="56px" Style="text-align: center; margin-top: 0px" 
                      Width="325px">Select Year (Fiscal):</asp:TextBox>
                <asp:RadioButtonList ID="YearChoice1" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
                  ...
                  <br />
                  <br />
                  <asp:TextBox ID="Year3" runat="server" BorderStyle="None" Font-Bold="True" 
                      Font-Size="Large" ForeColor="Blue" Height="24px" 
                      Style="text-align: center; margin-top: 0px" Width="325px">Select Customer</asp:TextBox>
                  <br />
                  <br />
                  <asp:CheckBox ID="ChkCust" runat="server" />
                  <asp:DropDownList ID="CustomerList" runat="server" DataSourceID="cms1" 
                      DataTextField="BVNAME" DataValueField="BVNAME" Height="29px" Width="218px">
                  </asp:DropDownList>
                  <asp:SqlDataSource ID="cms1" runat="server" 
                      ConnectionString="<%$ ConnectionStrings:cms1 %>" 
            ...
            <asp:Panel ID="PanelTrialBalance" Visible="true" runat="server">
                ...
                <asp:Label ID="LblNofound" runat="server" Font-Bold="True" Font-Size="20pt"></asp:Label>
                <br />
            </asp:Panel>
        </ContentTemplate>
    </asp:UpdatePanel>
